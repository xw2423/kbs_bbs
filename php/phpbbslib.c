...
#define MY_REGISTER_STRING_CONSTANT(name, str, flags)  zend_register_string_constant((name), strlen(name)+1, (char*)(str), (flags), module_number TSRMLS_CC)
    ...
    REGISTER_LONG_CONSTANT("BBS_BOARD_MEMBERPOST", BOARD_MEMBER_POST, CONST_CS | CONST_PERSISTENT);
#endif
	...
	REGISTER_LONG_CONSTANT("BBS_BMEMBER_STATUS_BLACK", BOARD_MEMBER_STATUS_BLACK, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("BBS_BMEMBER_STATUS_TYPES", BOARD_MEMBER_STATUS_TYPES, CONST_CS | CONST_PERSISTENT);
